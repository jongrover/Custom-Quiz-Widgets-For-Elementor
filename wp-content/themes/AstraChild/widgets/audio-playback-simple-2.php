...
class Audio_Playback_Simple_2_Widget extends Widget_Base {
    ...
    echo "<style>.player-box{padding:1rem;text-align:center;}button{height:3.5rem;min-width:2rem;border:none;border-radius:.15rem;padding:0px 10px;box-shadow:inset 0 -.15rem 0 rgba(0,0,0,.2);cursor:pointer;display:inline-block;justify-content:center;align-items:center;color:#fff;font-weight:700;font-size:1rem}.playButton2{background:green;}.stpButton2{background:#555;display:none;}button:focus,button:hover{outline:0;}button::-moz-focus-inner{border:0}button:active{box-shadow:inset 0 1px 0 rgba(0,0,0,.2);}.playButton2:focus, .playButton2:hover,.playButton2:active{background:darkgreen}.stpButton2:focus, .stpButton2:hover,.stpButton2:active{background:#333;}button:disabled{pointer-events:none;background:#d3d3d3}button:first-child{margin-left:0}.player-box audio{display:none;}</style>

...
class Yoast_I18n_v3 {
	...
	private function promo_message() {
		...
		if ( $message ) {
			$message = '<p>' . $message . '</p><p><a href="' . esc_url( $this->register_url ) . '">' . esc_html__( 'Register now &raquo;', $this->textdomain, 'yoast-video-seo' ) . '</a></p>';
		}
	...
	public function get_dismiss_i18n_message_button() {
		return sprintf(
			...
			esc_html__( '%1$sPlease don\'t show me this notification anymore%2$s', $this->textdomain, 'yoast-video-seo' ),
	...
	public function promo() {
		...
		if ( $message ) {
			...
			echo '<h2>' . sprintf( esc_html__( 'Translation of %s', $this->textdomain, 'yoast-video-seo' ), esc_html( $this->plugin_name ) ) . '</h2>';

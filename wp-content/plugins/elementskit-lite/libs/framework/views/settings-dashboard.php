...
<div class="ekit-admin-section ekit-admin-faq-section">
    ...
    <div class="ekit-admin-video-tutorial-list">
        <div class="ekit-admin-video-tutorial-item">
            <a target="_blank" href="https://products.wpmet.com/elementskit/effects/">
    ...
    <div class="ekit-admin-right-content--button attr-text-center">
        <a target="_blank" href="https://www.youtube.com/watch?v=ps7knxZpDFI&list=PL3t2OjZ6gY8MVnyA4OLB6qXb77-roJOuY" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-check-circle"></i><?php esc_html_e('View more videos', 'elementskit-lite'); ?></a>
    </div>
</div>
...
<div class="ekit-admin-section ekit-admin-dual-layout ekit-admin-feature-request-section ekit-admin-except-title">
    ...
    <div class="ekit-admin-right-content">
        ...
        <div class="ekit-admin-right-content--button">
            <a target="_blank" href="http://go.wpmet.com/ekit-feature-request" class="attr-btn attr-btn-primary ekit-admin-right-content--link"><i class="fa fa-check-circle"></i><?php esc_html_e('Feature request', 'elementskit-lite'); ?></a>
        </div>
    </div>
</div>
